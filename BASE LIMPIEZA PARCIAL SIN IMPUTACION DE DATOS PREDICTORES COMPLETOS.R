#########################################################################
#########################################################################
#BASE LIMPIEZA PARCIAL. SIN IMPUTACIÓN DE DATOS. PREDICTORES COMPLETOS.#
########################################################################
########################################################################
...
var_eliminar<-c("region", "municipi" "subregio","cod_dept","particin","dane","munic","dominio","upm",
                "codigoi","serie","orden","fexp","nombre_c","p13","p14","p20","p24","p34_1",
...
#Explicacion: aquellos que no respondieron corresponden a alumnos que no perdieron ningun aÃ±o
...
pasar_missing_9<-list("p9","p11","p12","p15","p16","p17","p18","p19","p23","p25","p27",
                      ...
                      "p38_f","p39_a","p39_b","p39_c","p39_d","p40_a","p40_b","p40_c","p40_d","p40_e",
                      "p40_f","p43_a","p43_b","p43_c","p43_d","p43_e","p43_f","p43_g","p43_h","p43_i",
                      "p43_j","p43_k","p43_l","p43_m","p43_n","p43_o","p43_p","p44_a","p44_b","p44_c",
                      "p44_d","p44_e","p44_f","p44_g","p44_h","p44_i","p44_j","p44_k","p44_l","p44_m",
                      "p44_n","p44_o","p44_p","p47_a","p47_b","p47_c","p47_d","p49","p50p","p50m",
                      "p51_1","p51_2","p51_3","p51_4","p51_5","p51_6","p54","p55","p57","p59","p60",
                      "p61","p62_a","p62_b","p62_c","p62_d","p62_e","p62_f","p62_g","p67_a","p67_b",
                      "p67_c","p68_a","p68_b","p68_c","p68_d","p68_e","p68_f","p68_g","p68_h","p68_i",
                      "p68_j","p69","p70","p72","p74","p75","p13c","p14c","p26_1","p26_2","p26_3",
                      "p26_4","p26_5","p71_1","p71_2","p71_3","p71_4","p71_5")

pasar_missing_99<-list("p21","p48_1","p48_2","p48_3","p48_4","p48_5","p48_6","p48_7","p48_8","p48_9",
                       "p48_10","p48_11","p48_12","p63_1","p63_2","p63_3","p65_1","p65_2","p65_3")
...
#Se hayan las proporciones de la variable de interés
...
#ahora la variable responde a la pregunta Â¿cree o no?
...
#Â¿que tan facil o dificil es conseguir drogas?
...
#4 pasa a 0 ya que indica que el individuo no posee informacion para responder
#se resumen todas las variables como una suma ponderada. De esta manera se responde a la pregunta
#Â¿que tan facil o dificil es comprar licor?
...
########################################################
#CONTINUAR CON LA LIMPIEZA DE LOS PREDICTORES ESCOGIDOS#
###############CULMINACION DE LA ETAPA IV###############
########################################################
